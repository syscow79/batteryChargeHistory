...
public class BatteryCheckServiceChange extends Service{

    public static final String BATTERY_UPDATE = "BatteryCheckServiceChange.BATTERY_UPDATE";
    public static final String BATTERY_UPDATED = "BatteryCheckServiceChange.BATTERY_UPDATED";
    public static final String EXTRA_BATTERY_LEVEL = "BatteryCheckServiceChange.EXTRA_BATTERY_LEVEL";
    private MyLogDb myLogDb = MyLogDb.getInstance();
    private static boolean startedAlarm = false;

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("BatteryCheckServiceChange", "onStartCommand");
    ...
    private class BatteryCheckAsync extends AsyncTask<Object, Object, Void> {
        ...
        protected Void doInBackground(Object... arg0) {
            ...
            try {
                ...
                Log.e("BatteryCheckServiceChange", e.getMessage());
            }
